...
export default function CameraFeed({ onResults, enabled = true, showFps = true }: CameraFeedProps) {
    ...
    <div className="relative camera-container w-full aspect-video bg-dark-900 rounded-2xl overflow-hidden">
      ...
      {isLoading && (
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-dark-900/90 backdrop-blur-sm">
          <motion.div animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: 'linear' }} className="text-purple-400 mb-3">
